        ...
        <tbody>
          ...
          ?>
            <tr>
                ...
                <a class="btn btn-success" href="<?php echo base_url()?>Status_Controller/active_status_user/<?= $value['uid']?>">Active</a>

                 <?php } else { ?>

            <a class="btn btn-danger" href="<?php echo base_url()?>Status_Controller/deactiv_status_user/<?= $value['uid']?>">Deactive</a>
                <?php }?>
                </td>
